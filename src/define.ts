 ...
 * 利用する記号
 */
export const symbol = "'，．・？！＝～ー（）「」＜＞＆＃＄％★";
/**
 * 濁点を付けることが可能なひらがな
 */
export const canVoiced = "かきくけこさしすせそたちつてとはひふへほ";
/**
 * 半濁点を付けることが可能なひらがな
 */
export const canSemiVoiced = "はひふへほ";
/**
 * 小文字にすることが可能なひらがな
 */
export const canSmall = "あいうえおつやゆよわ";
/**
 * 濁点付きひらがな
 */
export const voicedChar = "がぎぐげござじずぜぞだぢづでどばびぶべぼ";
/**
 * 半濁点付きひらがな
 */
export const semiVoicedChar = "ぱぴぷぺぽ";
/**
 * 小文字ひらがな
 */
export const smallChar = "ぁぃぅぇぉっゃゅょゎ";
/**
 * ばびぶべぼ
 */
export const bChar = "ばびぶべぼ";
